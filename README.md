...
#>    ea_id    region   province commune urban_rural population households area_km2
#>  * <chr>    <fct>    <fct>    <fct>   <fct>            <dbl>      <int>    <dbl>
#>  1 EA_00268 Boucle … Bale     Bagassi Rural              927        111    41.7 
#>  2 EA_02157 Boucle … Bale     Boromo  Rural              129         17     8.12
#>  3 EA_10375 Boucle … Bale     Pa      Rural              943        133     4.73
#>  4 EA_06846 Boucle … Banwa    Kouka   Rural             3546        408    12.2 
#>  5 EA_11697 Boucle … Banwa    Sanaba  Rural             1359        197    31.2 
#>  6 EA_12357 Boucle … Banwa    Solenzo Rural              908        108    17.5 
#>  7 EA_12411 Boucle … Banwa    Solenzo Rural             1341        160     0.46
#>  8 EA_12891 Boucle … Banwa    Tansila Rural             1656        211    61.1 
#>  9 EA_02518 Boucle … Kossi    Bouras… Rural              806         91    14.8 
#> 10 EA_03575 Boucle … Kossi    Djibas… Rural              773         92     0.39
#> # ℹ 290 more rows
#> # ℹ 9 more variables: accessible <lgl>, dist_road_km <dbl>,
#> #   food_insecurity_pct <dbl>, cost <dbl>, .weight <dbl>, .sample_id <int>,
#> #   .stage <int>, .weight_1 <dbl>, .fpc_1 <int>
...
#>    ea_id    region   province commune urban_rural population households area_km2
#>  * <chr>    <fct>    <fct>    <fct>   <fct>            <dbl>      <int>    <dbl>
#>  1 EA_05883 Hauts-B… Kenedou… Kayan   Rural             1572        190    33.0 
#>  2 EA_12026 Nord     Yatenga  Sengue… Rural             1774        220    19.6 
#>  3 EA_08856 Centre   Kadiogo  Ouagad… Urban             2051        389     0.37
#>  4 EA_14625 Centre-… Bam      Zimtan… Rural             1531        272    11.6 
#>  5 EA_10472 Est      Kompien… Pama    Rural             1382        179    66.4 
#>  6 EA_14276 Boucle … Nayala   Ye      Rural             1314        232     2.27
#>  7 EA_03283 Est      Gourma   Diabo   Rural             1505        187    33.1 
#>  8 EA_01810 Hauts-B… Houet    Bobo-D… Urban             2759        442     0.37
#>  9 EA_00658 Sahel    Seno     Bani    Rural             1458        312    17.8 
#> 10 EA_03897 Sahel    Seno     Dori    Rural             1054        137    10.1 
#> # ℹ 90 more rows
#> # ℹ 9 more variables: accessible <lgl>, dist_road_km <dbl>,
#> #   food_insecurity_pct <dbl>, cost <dbl>, .weight <dbl>, .sample_id <int>,
#> #   .stage <int>, .weight_1 <dbl>, .fpc_1 <int>
...
#>  1 EA_00244 Bulawayo Bulawayo Urban             1213        331     0.54
#>  2 EA_00014 Bulawayo Bulawayo Rural             1392        335    31.6 
#>  3 EA_00374 Bulawayo Bulawayo Urban             1352        389     0.38
#>  4 EA_00153 Bulawayo Bulawayo Urban             1254        325     0.79
#>  5 EA_00090 Bulawayo Bulawayo Urban             1232        340     1.97
#>  6 EA_01342 Harare   Harare   Urban             1837        475     1.03
#>  7 EA_01507 Harare   Harare   Urban             1431        388     0.24
#>  8 EA_01448 Harare   Harare   Urban             1218        345     0.43
#>  9 EA_00830 Harare   Harare   Urban             1246        372     0.3 
#> 10 EA_01692 Harare   Harare   Urban             1222        362     0.75
#> # ℹ 40 more rows
