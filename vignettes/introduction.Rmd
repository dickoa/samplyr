...
```{r}
niger_eas$prn <- withr::with_seed(42, runif(nrow(niger_eas)))

sample_prn <- sampling_design() |>
  cluster_by(ea_id) |>
...
| `pps_cps` | Fixed | No | Joint inclusion probs available |
...
| `pps_chromy` | Fixed | PMR | Chromy's sequential PPS |
