...
For the statistical semantics and assumptions underlying each operation, see `vignette("design-semantics")`. For survey export workflows, see `vignette("survey-analysis")`. For sample coordination with permanent random numbers, see `vignette("sampling-coordination")`.
